...
import com.jasonfoglia.universalrobotcontroller.licensing.LicenseCheckerCallback.ApplicationErrorCode;
import com.jasonfoglia.universalrobotcontroller.licensing.Policy.LicenseResponse;
import com.jasonfoglia.universalrobotcontroller.licensing.util.Base64;
import com.jasonfoglia.universalrobotcontroller.licensing.util.Base64DecoderException;

/**
 * Contains data related to a com.jasonfoglia.universalrobotcontroller.licensing request and methods to verify
...
class LicenseValidator {
    ...
    public void verify(PublicKey publicKey, int responseCode, String signedData, String signature) {
        ...
        switch (responseCode) {
            ...
            case ERROR_CONTACTING_SERVER:
                Log.w(TAG, "Error contacting com.jasonfoglia.universalrobotcontroller.licensing server.");
                handleResponse(LicenseResponse.RETRY, data);
                break;
            case ERROR_SERVER_FAILURE:
                Log.w(TAG, "An error has occurred on the com.jasonfoglia.universalrobotcontroller.licensing server.");
                handleResponse(LicenseResponse.RETRY, data);
                break;
     ...
     * @param rawData
     */
    private void handleResponse(LicenseResponse response, ResponseData rawData) {
