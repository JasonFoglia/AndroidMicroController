...
import com.jasonfoglia.universalrobotcontroller.licensing.util.URIQueryDecoder;

/**
 * Default policy. All policy decisions are based off of response data received
 * from the com.jasonfoglia.universalrobotcontroller.licensing service. Specifically, the com.jasonfoglia.universalrobotcontroller.licensing server sends the
 ...
 * application is checking with the com.jasonfoglia.universalrobotcontroller.licensing service.
 * <p>
 * Developers who need more fine grained control over their application's
 * com.jasonfoglia.universalrobotcontroller.licensing policy should implement a custom Policy.
 */
public class ServerManagedPolicy implements Policy {

    private static final String TAG = "ServerManagedPolicy";
    private static final String PREFS_FILE = "com.android.vending.com.jasonfoglia.universalrobotcontroller.licensing.ServerManagedPolicy";
