...
public class LicenseChecker implements ServiceConnection {
    ...
    public synchronized void checkAccess(LicenseCheckerCallback callback) {
        ...
        if (mPolicy.allowAccess()) {
            ...
            if (mService == null) {
               Log.i(TAG, "Binding to com.jasonfoglia.universalrobotcontroller.licensing service.");
                try {
    ...
    private void cleanupService() {
        if (mService != null) {
            try {
                ...
                Log.e(TAG, "Unable to unbind from com.jasonfoglia.universalrobotcontroller.licensing service (already unbound)");
            }
            mService = null;
        }
    }
